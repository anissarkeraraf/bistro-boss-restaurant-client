...
const Featurd = () => {
    return (
        <div className="featured-section bg-fixed pt-5 text-white">
            ...
            <div className="md:flex justify-center items-center pb-20 pt-12 px-20 bg-slate-500 bg-opacity-50">
                ...
                <div className="ml-10">
                    ...
                    <div className="mt-5">
                        <button className="py-2 btn-outline border-b-4 rounded px-2  border-black">Order Now</button>
                    </div>
                </div>
            </div>
